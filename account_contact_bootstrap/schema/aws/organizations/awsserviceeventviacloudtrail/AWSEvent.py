...
from schema.aws.organizations.awsserviceeventviacloudtrail.AWSServiceEventViaCloudTrail import AWSServiceEventViaCloudTrail  # noqa: F401,E501

class AWSEvent(object):


    _types = {
        'detail': 'AWSServiceEventViaCloudTrail',
        'detail_type': 'str',
        'resources': 'list[str]',
        'id': 'str',
        'source': 'str',
